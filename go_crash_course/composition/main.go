...
type Car struct {
	...
	IsElectric bool
	IsHybrid bool
	Vehicle Vehicle   // This is called a composition. We are building the type car struct and embedding the vehicle struct in it, which means the car has access to the things that are in vehicle
}
